...
const TranslationCard = ({ fromLanguage, setFromLanguage, toLanguage, setToLanguage, languages, onSwapLanguages }) => {
    ...
    return (
        <SafeAreaView style={[styles.container, { backgroundColor: theme.colors.background }]} edges={['bottom']}>
            ...
            >
                <Card style={[styles.card, { backgroundColor: theme.colors.surface, elevation: isDarkTheme ? 0 : 2 }]}>
                ...
                <Card style={[styles.card, { backgroundColor: theme.colors.surface, elevation: isDarkTheme ? 0 : 2 }]}>
                    <Card.Content>
                        ...
                        <View style={styles.actionRow}>
                            <Text style={{ color: theme.colors.onSurfaceVariant, fontSize: 12 }}>{inputText.length}/500</Text>
                ...
                {translatedText ? (
                    <Card style={[
                        ...
                        <Card.Content>
                            ...
                            <Text variant="bodyLarge" style={[styles.translatedText, { color: theme.colors.onSurface }]}>{translatedText}</Text>
                        </Card.Content>
                    </Card>
                ) : null}
            </ScrollView>
